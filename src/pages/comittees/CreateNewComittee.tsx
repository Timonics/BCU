...
const CreateNewComittee: React.FC = () => {
  const { setIsCreateNewClassOpen } = useStates();
  return (
    <div className="fixed w-[40%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 rounded-xl bg-white shadow-xl flex flex-col items-center gap-4">
      <button
      ...
      <div className="w-full flex flex-col gap-4">
        <h2 className="text-2xl font-bold pops">Create Comittee</h2>
        <div className="flex flex-col gap-2 mt-3">
          <p className="text-sm">
            Comittee ID <span className="text-red-600">*</span>
          </p>
          <input className="member-input outline-none" />
        </div>
        <div className="flex flex-col gap-2">
          <p className="text-sm">
            Comittee Name<span className="text-red-600">*</span>
          </p>
          <input className="member-input outline-none" />
        </div>
        <div className="flex flex-col gap-2">
...
export default CreateNewComittee;
