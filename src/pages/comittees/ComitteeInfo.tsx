...
import { genders, classes, comittees } from "../../constants/listings";

type BandProps = {
  comitteeName: string;
  comitteeYears: number;
  nextAnniversary: string;
};

const ComitteeInfo: React.FC<BandProps> = ({
  comitteeName,
  comitteeYears,
  nextAnniversary,
}) => {
